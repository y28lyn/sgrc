...
if ($_SESSION["role"] == "service") {
    ...
    <body>
        ...
        <p class="texte2"> Nombre de couvert :
            <?php echo $nb_couverts_recup; ?> &nbsp; <a href="index.php?page=nbcouv_modif"><i
            ...
            <div class="container">
                <div class="tabs">
                    ...
                    foreach ($categories as $categorie) {
                        ...
                        ?>
                        <button class="tab-button" id="tab-button-<?php echo $cat; ?>">
                ...
                foreach ($categories as $categorie) {
                    ...
                    <div class="tab-content" id="tab-content-<?php echo $cat; ?>">
                        ...
                        foreach ($souscats as $souscat) {
                            ...
                            ?>
                            <button class="sub-tab-button" onclick="toggleSubTabContent('<?php echo $sous_cat; ?>')">
                                <?php echo $souscat['nom_sous_cat']; ?>
                            </button>
    ...
    <table>
        <?php foreach ($platsConsolides as $plat): ?>
            ...
            <tr>
                ...
                <!-- Form et bouton suppression d'une itération d'un plat -->
                <td>
                    <?php
                    switch (true) {
                        case isset($ligne['Statuts']) && $ligne['Statuts'] == 'En cours':
