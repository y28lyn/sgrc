...
(5, 'Verrine Méditerranéenne', 'Mise en bouche', 'entree', 0.00, 1, 1),
(6, 'Oeuf mollet frit aux champignons noir', 'Oeuf mollet frit aux champignons ', 'entree', 0.00, 2, 1),
(7, 'blanquette de veau au lait de coco', 'Pommes Macaire, cèpes et tomates confites', 'plat', 0.00, 3, 1),
(8, 'Profiteroles au Gianduja', 'Profiteroles au Gianduja', 'dessert', 0.00, 4, 1),
...
(20, 'AOC CrÃ©ment de bourgogne 75cl', 'cave de lugny', 'boisson', 19.50, 13, 1),
...
(28, 'AOC cotes du rhone 1/2 ROUGE 37.5cl', 'domaine Guigal 2018', 'boisson', 11.50, 11, 1),
(30, 'café', 'café', 'boisson', 1.50, 8, 0),
(31, 'IGP Mediterrannée ROUGE 75cl', '2018 collines de laure', 'boisson', 19.00, 11, 0),
(32, 'AOC bourgogne ROUGE 75cl', 'domaine antonin 2018', 'boisson', 22.00, 11, 1),
...
(82, 'mini wrap Saumon Fumé', 'mini wrap saumon fumé', 'plat', 0.00, 2, 1),
(83, 'karaage', '???', 'plat', 0.00, 2, 1),
(84, 'Ramen', 'Ramen de viande et Miso', 'plat', 0.00, 3, 1),
(85, 'Dando', 'raviole japonaise sucrée', 'plat', 0.00, 4, 1),
...
(88, 'Croquette de pomme de terre au jambon', 'Croquette de pomme de terre au jambon', 'plat', 0.00, 1, 0),
(89, 'Baguette façon pizza aubergine tomates mozzarella', '', 'plat', 0.00, 3, 0),
(90, 'Tarte poire noisette pistache façon pain perdu', '', 'plat', 0.00, 4, 0),
(91, 'Velouté de poisson pickles salicornes algues', '', 'plat', 0.00, 2, 0),
...
ALTER TABLE `ligne_ticket`
  MODIFY `id_ligne_ticket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22408;

ALTER TABLE `menu`
  MODIFY `id_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

ALTER TABLE `plat`
  MODIFY `id_plat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

ALTER TABLE `sgr_table`
  MODIFY `id_table` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

ALTER TABLE `sous_categorie`
  MODIFY `id_sous_cat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
